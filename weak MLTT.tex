...
$$\frac{\Gamma \vdash A:\mathrm{Prop}}{\Gamma \vdash A \; \mathrm{type}} \qquad \frac{\Gamma \; \mathrm{ctx}}{\Gamma \vdash \mathrm{proptrunc}:\prod_{A:\mathrm{Prop}} \mathrm{isProp}(\mathrm{El}(A))}$$
...
$$\frac{\Gamma \; \mathrm{ctx}}{\Gamma \vdash \eta_{\mathrm{Prop}}:\prod_{A:\mathrm{Prop}} A =_{\mathrm{Prop}} \mathrm{toProp}_{A}(\mathrm{proptrunc}(A))}$$

Extensionality principle of the type of propositions:
...
$$\frac{\Gamma \vdash A \equiv A':\mathrm{Prop}}{\Gamma \vdash A \equiv A' \; \mathrm{type}}$$
